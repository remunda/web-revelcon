...
- **Gentle wind sway**: Inner `<g class="sway">` elements run `letterSway` keyframes (subtle rotation -1.4° to +1.5° and translation ±0.8px to ±2.2px on 4.2s–6.0s out-of-phase loops) starting immediately as each letter arrives (~51.20s–51.62s).
